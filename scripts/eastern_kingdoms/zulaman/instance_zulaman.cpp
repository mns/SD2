...
uint64 instance_zulaman::GetData64(uint32 uiData)
{
    switch(uiData)
    {
        ...
        case GO_TANZARS_TRUNK:    return m_auiChestGUIDs[0];
        case GO_KRAZS_PACKAGE:    return m_auiChestGUIDs[1];
        case GO_ASHLIS_BAG:       return m_auiChestGUIDs[2];
        case GO_HARKORS_SATCHEL:  return m_auiChestGUIDs[3];

        case GO_TANZARS_CAGE:     return m_auiEventChestNpcCageGUIDs[0];
        case GO_KRAZS_CAGE:       return m_auiEventChestNpcCageGUIDs[1];
        case GO_ASHLIS_CAGE:      return m_auiEventChestNpcCageGUIDs[2];
